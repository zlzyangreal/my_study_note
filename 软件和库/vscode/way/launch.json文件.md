...
                {
	                // LD_LIBRARY_PATH见下
                    "name": "LD_LIBRARY_PATH", "value": "/home/orangepi/Desktop/WJ/proj/install/rk3588_linux_aarch64/rknn_wj_demo/lib"
                }
            ], 
...
            "program": "${workspaceFolder}/install/rk3588_linux_aarch64/rknn_wj_demo/wj",
...
```
* [环境变量LD_LIBRARY_PATH](linux环境变量) 在Linux下必须链接
